...
const DEFAULT_BUILDING_PRODUCTION_BY_ID: Record<number, DefaultBuildingProductionDefinition> = {

  // ======== 采掘类 ID 0-14 ========
  // 设计原则：revenue@basePrice ≥ fixedCost × 1.10，ticksRequired=1（日产=amount）
  ...
  variants: [
    {
      ...
      name: '铁矿开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.IRON_ORE, amount: 200 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 200,
    },
  ...
  variants: [
    {
      ...
      name: '铜矿开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.COPPER_ORE, amount: 130 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 220,
    },
  ...
  variants: [
    {
      ...
      name: '铝矿开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.BAUXITE, amount: 220 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 200,
    },
  ...
  variants: [
    {
      ...
      name: '煤炭开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.COAL, amount: 100 }],
      ticksRequired: 1,
      laborRequired: 55,
      energyRequired: 220,
    },
  ...
  variants: [
    {
      ...
      name: '硅矿开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.SILICON, amount: 240 }],
      ticksRequired: 1,
      laborRequired: 45,
      energyRequired: 180,
    },
  ...
  variants: [
    {
      ...
      name: '锂矿开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.LITHIUM, amount: 100 }],
      ticksRequired: 1,
      laborRequired: 55,
      energyRequired: 280,
    },
  ...
  variants: [
    {
      ...
      name: '稀土开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.RARE_EARTH, amount: 100 }],
      ticksRequired: 1,
      laborRequired: 60,
      energyRequired: 250,
    },
  ...
  variants: [
    {
      ...
      name: '木材采伐',
      inputs: [],
      outputs: [{ goodsId: GoodsId.TIMBER, amount: 220 }],
      ticksRequired: 1,
      laborRequired: 60,
      energyRequired: 100,
    },
  ...
  variants: [
    {
      ...
      name: '粮食种植',
      inputs: [],
      outputs: [{ goodsId: GoodsId.GRAIN, amount: 400 }],
      ticksRequired: 1,
      laborRequired: 80,
      energyRequired: 50,
    },
    {
      ...
      name: '棉花种植',
      inputs: [],
      outputs: [{ goodsId: GoodsId.COTTON, amount: 300 }],
      ticksRequired: 1,
      laborRequired: 70,
      energyRequired: 40,
      unlockLevel: 2,
  ...
  variants: [
    {
      ...
      name: '橡胶种植',
      inputs: [],
      outputs: [{ goodsId: GoodsId.RUBBER_RAW, amount: 140 }],
      ticksRequired: 1,
      laborRequired: 60,
      energyRequired: 50,
    },
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.LIVESTOCK, amount: 40 }],
      ticksRequired: 1,
      laborRequired: 100,
      energyRequired: 80,
    },
  ...
  variants: [
    {
      ...
      name: '渔获捕捞',
      inputs: [],
      outputs: [{ goodsId: GoodsId.SEAFOOD, amount: 300 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 60,
    },
  ...
  variants: [
    {
      ...
      name: '药材种植',
      inputs: [],
      outputs: [{ goodsId: GoodsId.HERBS, amount: 80 }],
      ticksRequired: 1,
      laborRequired: 40,
      energyRequired: 30,
    },
  ...
  variants: [
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.ALUMINUM, amount: 530 }],
      ticksRequired: 1,
      laborRequired: 45,
      energyRequired: 600,
      unlockLevel: 2,
  ...
  variants: [
    {
      modeId: 0,
      name: '炼油',
      inputs: [{ goodsId: GoodsId.CRUDE_OIL, amount: 200 }],
      outputs: [
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.CHEMICALS, amount: 400 }],
      ticksRequired: 1,
      laborRequired: 75,
      energyRequired: 650,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.RUBBER, amount: 1000 }],
      ticksRequired: 1,
      laborRequired: 55,
      energyRequired: 220,
      unlockLevel: 2,
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.PAPER, amount: 450 }],
      ticksRequired: 1,
      laborRequired: 40,
      energyRequired: 200,
    },
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.TEXTILES, amount: 350 }],
      ticksRequired: 1,
      laborRequired: 60,
      energyRequired: 150,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.SILK, amount: 100 }],
      ticksRequired: 1,
      laborRequired: 80,
      energyRequired: 120,
      unlockLevel: 2,
  ...
  variants: [
    {
      modeId: 0,
      name: '食品加工',
      inputs: [{ goodsId: GoodsId.GRAIN, amount: 500 }],
    ...
    },
    {
      modeId: 1,
      name: '饮料生产',
      inputs: [{ goodsId: GoodsId.GRAIN, amount: 300 }],
    ...
    },
    {
      ...
      name: '零食生产',
      inputs: [
          { goodsId: GoodsId.GRAIN, amount: 400 },
          { goodsId: GoodsId.PACKAGING, amount: 100 },
        ],
      outputs: [{ goodsId: GoodsId.SNACKS, amount: 4500 }],
      ticksRequired: 1,
      laborRequired: 30,
      energyRequired: 80,
      unlockLevel: 2,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.FOOD, amount: 2000 }],
      ticksRequired: 1,
      laborRequired: 40,
      energyRequired: 80,
      unlockLevel: 2,
    },
    {
      ...
      name: '宠物食品生产',
      inputs: [
          { goodsId: GoodsId.MEAT, amount: 100 },
          { goodsId: GoodsId.GRAIN, amount: 150 },
        ],
      outputs: [{ goodsId: GoodsId.PET_FOOD, amount: 3000 }],
      ticksRequired: 1,
      laborRequired: 35,
      energyRequired: 90,
      unlockLevel: 3,
    },
    {
      ...
      name: '有机食品生产',
      inputs: [
          { goodsId: GoodsId.GRAIN, amount: 200 },
          { goodsId: GoodsId.DAIRY, amount: 80 },
        ],
      outputs: [{ goodsId: GoodsId.ORGANIC_FOOD, amount: 2200 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 100,
      unlockLevel: 2,
  ...
  variants: [
    {
      modeId: 0,
      name: '肉类加工',
      inputs: [{ goodsId: GoodsId.LIVESTOCK, amount: 30 }],
      outputs: [{ goodsId: GoodsId.MEAT, amount: 900 }],
      ticksRequired: 1,
      laborRequired: 60,
      energyRequired: 150,
    },
    {
      ...
      name: '冷冻食品生产',
      inputs: [
          { goodsId: GoodsId.MEAT, amount: 200 },
          { goodsId: GoodsId.SEAFOOD, amount: 100 },
        ],
      outputs: [{ goodsId: GoodsId.FROZEN_FOOD, amount: 2400 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 200,
      unlockLevel: 2,
    },
    {
      ...
      name: '罐头食品生产',
      inputs: [
          { goodsId: GoodsId.MEAT, amount: 150 },
          { goodsId: GoodsId.PROCESSED_FOOD, amount: 50 },
        ],
      outputs: [{ goodsId: GoodsId.CANNED_FOOD, amount: 2000 }],
      ticksRequired: 1,
      laborRequired: 45,
      energyRequired: 120,
    },
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.DAIRY, amount: 1800 }],
      ticksRequired: 1,
      laborRequired: 30,
      energyRequired: 100,
    },
  ...
  variants: [
    ...
    },
    {
      ...
      name: '包装材料生产',
      inputs: [
          { goodsId: GoodsId.PAPER, amount: 300 },
          { goodsId: GoodsId.PLASTIC, amount: 100 },
        ],
      outputs: [{ goodsId: GoodsId.PACKAGING, amount: 4000 }],
      ticksRequired: 1,
      laborRequired: 45,
      energyRequired: 140,
      unlockLevel: 2,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.BUILDING_PRODUCTS, amount: 600 }],
      ticksRequired: 1,
      laborRequired: 60,
      energyRequired: 220,
      unlockLevel: 2,
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.ELECTRONICS, amount: 200 }],
      ticksRequired: 1,
      laborRequired: 75,
      energyRequired: 300,
    },
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.DRONE, amount: 6 }],
      ticksRequired: 1,
      laborRequired: 90,
      energyRequired: 180,
      unlockLevel: 3,
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.CHIPS, amount: 500 }],
      ticksRequired: 1,
      laborRequired: 180,
      energyRequired: 900,
    },
  ...
  variants: [
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.ENERGY_STORAGE, amount: 12 }],
      ticksRequired: 1,
      laborRequired: 80,
      energyRequired: 300,
      unlockLevel: 2,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.SOLAR_SYSTEM, amount: 12 }],
      ticksRequired: 1,
      laborRequired: 120,
      energyRequired: 250,
      unlockLevel: 3,
  ...
  variants: [
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.SCREEN, amount: 200 }],
      ticksRequired: 1,
      laborRequired: 70,
      energyRequired: 250,
      unlockLevel: 2,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.CAR_PARTS, amount: 350 }],
      ticksRequired: 1,
      laborRequired: 140,
      energyRequired: 420,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.MECHANICAL_PARTS, amount: 400 }],
      ticksRequired: 1,
      laborRequired: 70,
      energyRequired: 220,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.AIRCRAFT_PARTS, amount: 100 }],
      ticksRequired: 1,
      laborRequired: 120,
      energyRequired: 350,
      unlockLevel: 3,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.CLOTHING_FABRIC, amount: 240 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 100,
    },
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.CAR, amount: 3 }],
      ticksRequired: 1,
      laborRequired: 240,
      energyRequired: 520,
    },
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.FURNITURE, amount: 80 }],
      ticksRequired: 1,
      laborRequired: 100,
      energyRequired: 150,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.CLOTHING, amount: 1200 }],
      ticksRequired: 1,
      laborRequired: 95,
      energyRequired: 110,
      unlockLevel: 2,
  ...
  variants: [
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.WIND_BLADE, amount: 120 }],
      ticksRequired: 1,
      laborRequired: 100,
      energyRequired: 350,
      unlockLevel: 2,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.INDUSTRIAL_ROBOT, amount: 10 }],
      ticksRequired: 1,
      laborRequired: 150,
      energyRequired: 400,
      unlockLevel: 3,
  ...
  variants: [
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.VACCINE, amount: 120 }],
      ticksRequired: 1,
      laborRequired: 150,
      energyRequired: 400,
      unlockLevel: 3,
    },
    {
      ...
      name: '仿制药生产',
      inputs: [{ goodsId: GoodsId.PHARMA_BASE, amount: 200 }],
      outputs: [{ goodsId: GoodsId.GENERIC_DRUG, amount: 5000 }],
      ticksRequired: 1,
      laborRequired: 110,
      energyRequired: 260,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.PATENT_DRUG, amount: 400 }],
      ticksRequired: 1,
      laborRequired: 120,
      energyRequired: 300,
      unlockLevel: 2,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.OTC_DRUG, amount: 5000 }],
      ticksRequired: 1,
      laborRequired: 90,
      energyRequired: 220,
    },
  ...
  variants: [
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.MEDICAL_DEVICE, amount: 20 }],
      ticksRequired: 1,
      laborRequired: 100,
      energyRequired: 300,
      unlockLevel: 2,
  ...
  variants: [
    {
      ...
      name: '金矿开采',
      inputs: [],
      outputs: [{ goodsId: GoodsId.GOLD_ORE, amount: 30 }],
      ticksRequired: 1,
      laborRequired: 60,
      energyRequired: 300,
    },
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.GOLD, amount: 6 }],
      ticksRequired: 1,
      laborRequired: 40,
      energyRequired: 400,
      unlockLevel: 2,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.DIAMOND, amount: 6 }],
      ticksRequired: 1,
      laborRequired: 50,
      energyRequired: 200,
      unlockLevel: 2,
  ...
  variants: [
    ...
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.DESIGNER_CLOTHING, amount: 300 }],
      ticksRequired: 1,
      laborRequired: 120,
      energyRequired: 80,
      unlockLevel: 2,
  ...
  variants: [
    {
      ...
      outputs: [{ goodsId: GoodsId.ELECTRICITY, amount: 250000 }],
      ticksRequired: 1,
      laborRequired: 70,
      energyRequired: 0,
    },
    {
      ...
      outputs: [{ goodsId: GoodsId.ELECTRICITY, amount: 120000 }],
      ticksRequired: 1,
      laborRequired: 55,
      energyRequired: 0,
      unlockLevel: 2,
    },
    {
      ...
      name: '光伏发电',
      inputs: [],
      outputs: [{ goodsId: GoodsId.ELECTRICITY, amount: 20000 }],
      ticksRequired: 1,
      laborRequired: 18,
      energyRequired: 0,
      unlockLevel: 3,
  ...
  const methods = production.variants.map((variant) =>
    createMethod(
      ...
      variant.name,
      {
        ...
        laborDelta: variant.laborRequired ?? 0,
