...
const RAW_MATERIALS: GoodsDefinition[] = [
  ...
  { id: 4, key: 'crude_oil', name: '原油', category: 'raw', tier: 0, basePrice: 100, priceElasticity: -0.3, incomeElasticity: 0.4, isConsumerGood: false, unit: '桶', description: '石油化工的基础原料' },
  { id: 5, key: 'natural_gas', name: '天然气', category: 'raw', tier: 0, basePrice: 65, priceElasticity: -0.3, incomeElasticity: 0.4, isConsumerGood: false, unit: '立方米', description: '清洁能源和化工原料' },
...
const BASIC_MATERIALS: GoodsDefinition[] = [
  { id: 18, key: 'steel', name: '钢材', category: 'basic', tier: 1, basePrice: 150, priceElasticity: -0.5, incomeElasticity: 0.7, isConsumerGood: false, unit: '吨', description: '工业生产的核心材料' },
  ...
  { id: 21, key: 'fuel', name: '燃油', category: 'basic', tier: 1, basePrice: 120, priceElasticity: -0.3, incomeElasticity: 0.4, isConsumerGood: true, unit: '升', description: '汽车和机械用燃料' },
  { id: 22, key: 'plastic', name: '塑料', category: 'basic', tier: 1, basePrice: 70, priceElasticity: -0.6, incomeElasticity: 0.6, isConsumerGood: false, unit: '吨', description: '广泛使用的合成材料' },
  { id: 23, key: 'chemicals', name: '化学品', category: 'basic', tier: 1, basePrice: 160, priceElasticity: -0.4, incomeElasticity: 0.6, isConsumerGood: false, unit: '吨', description: '工业用化学品' },
  { id: 24, key: 'glass', name: '玻璃', category: 'basic', tier: 1, basePrice: 85, priceElasticity: -0.6, incomeElasticity: 0.6, isConsumerGood: false, unit: '平方米', description: '建筑和电子产品用玻璃' },
  { id: 25, key: 'cement', name: '水泥', category: 'basic', tier: 1, basePrice: 45, priceElasticity: -0.4, incomeElasticity: 0.5, isConsumerGood: false, unit: '吨', description: '建筑业的基础材料' },
...
const INTERMEDIATE_PRODUCTS: GoodsDefinition[] = [
  { id: 36, key: 'electronics', name: '电子元件', category: 'intermediate', tier: 2, basePrice: 320, priceElasticity: -0.6, incomeElasticity: 0.8, isConsumerGood: false, unit: '件', description: '电子产品的核心组件' },
  { id: 37, key: 'chips', name: '芯片', category: 'intermediate', tier: 2, basePrice: 550, priceElasticity: -0.5, incomeElasticity: 0.9, isConsumerGood: false, unit: '片', description: '高科技产品的大脑' },
  ...
  { id: 46, key: 'building_materials', name: '建筑材料', category: 'intermediate', tier: 2, basePrice: 110, priceElasticity: -0.5, incomeElasticity: 0.6, isConsumerGood: false, unit: '吨', description: '建筑施工用材料包' },
  { id: 47, key: 'packaging', name: '包装材料', category: 'intermediate', tier: 2, basePrice: 48, priceElasticity: -0.7, incomeElasticity: 0.5, isConsumerGood: false, unit: '套', description: '产品包装用材料' },
  ...
  { id: 53, key: 'beverages', name: '饮料', category: 'intermediate', tier: 2, basePrice: 12, priceElasticity: -0.5, incomeElasticity: 0.5, isConsumerGood: true, unit: '瓶', description: '各类饮品' },
...
const FINAL_PRODUCTS: GoodsDefinition[] = [
  { id: 56, key: 'smartphone', name: '智能手机', category: 'final', tier: 3, basePrice: 1200, priceElasticity: -1.5, incomeElasticity: 1.8, isConsumerGood: true, unit: '台', description: '智能手机' },
  { id: 57, key: 'computer', name: '电脑', category: 'final', tier: 3, basePrice: 1400, priceElasticity: -1.2, incomeElasticity: 1.4, isConsumerGood: true, unit: '台', description: '个人和办公计算设备' },
  { id: 58, key: 'appliances', name: '家电', category: 'final', tier: 3, basePrice: 650, priceElasticity: -1.2, incomeElasticity: 1.3, isConsumerGood: true, unit: '台', description: '家用电器' },
  ...
  { id: 60, key: 'car', name: '燃油汽车', category: 'final', tier: 3, basePrice: 28000, priceElasticity: -1.5, incomeElasticity: 2.0, isConsumerGood: true, unit: '辆', description: '传统燃油汽车' },
  { id: 61, key: 'electric_car', name: '电动汽车', category: 'final', tier: 3, basePrice: 38000, priceElasticity: -1.4, incomeElasticity: 2.2, isConsumerGood: true, unit: '辆', description: '新能源电动汽车' },
  ...
  { id: 63, key: 'clothing', name: '服装', category: 'final', tier: 3, basePrice: 90, priceElasticity: -1.0, incomeElasticity: 1.0, isConsumerGood: true, unit: '件', description: '日常穿着的服装' },
  { id: 64, key: 'food', name: '食品', category: 'final', tier: 3, basePrice: 25, priceElasticity: -0.3, incomeElasticity: 0.4, isConsumerGood: true, unit: '份', description: '日常消费食品' },
  ...
  { id: 66, key: 'electricity', name: '电力', category: 'final', tier: 3, basePrice: 0.6, priceElasticity: -0.2, incomeElasticity: 0.3, isConsumerGood: true, isService: true, unit: '度', description: '工业和民用电力' },
  ...
  { id: 71, key: 'generic_drug', name: '仿制药', category: 'final', tier: 3, basePrice: 55, priceElasticity: -0.5, incomeElasticity: 0.4, isConsumerGood: true, unit: '盒', description: '普通仿制药品' },
  ...
  { id: 73, key: 'otc_drug', name: '非处方药', category: 'final', tier: 3, basePrice: 35, priceElasticity: -0.4, incomeElasticity: 0.3, isConsumerGood: true, unit: '盒', description: 'OTC药品' },
  ...
  { id: 75, key: 'jewelry', name: '珠宝', category: 'final', tier: 3, basePrice: 12000, priceElasticity: -3.0, incomeElasticity: 4.0, isConsumerGood: true, unit: '件', description: '贵金属和宝石饰品' },
